...
class DiabetesClassifier:
    ...
    def define_feature(self):
        feature_cols = ['glucose', 'bp', 'bmi', 'insulin']
    ...
    def train(self):
        ...
        X_train, self.X_test, y_train, self.y_test = train_test_split(X, y, test_size=0.3, random_state=30)
    ...
    def examine(self):
        ...
        print(dist)
        percent_of_ones = self.y_test.mean() # has diabetes
        percent_of_zeros = 1 - self.y_test.mean() # doesn't have diabetes
